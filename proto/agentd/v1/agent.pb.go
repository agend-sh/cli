...
type ExecRequest struct {
	...
	// Return the interactive session's screen field as raw PTY bytes (ANSI
	// intact, no vt10x re-render, no decorative filtering) instead of the
	// LLM-oriented cleaned rendering. For a real terminal client driving its
	// own local emulator (agend connect), not for MCP tool consumers.
	RawOutput     bool   `protobuf:"varint,7,opt,name=raw_output,json=rawOutput,proto3" json:"raw_output,omitempty"`
	Columns       uint32 `protobuf:"varint,8,opt,name=columns,proto3" json:"columns,omitempty"` // initial PTY width for interactive clients
	Rows          uint32 `protobuf:"varint,9,opt,name=rows,proto3" json:"rows,omitempty"`       // initial PTY height for interactive clients
...
func (x *ExecRequest) GetRawOutput() bool {
	if x != nil {
		return x.RawOutput
	}
	return false
...
func (x *ConnectStart) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ConnectStart) GetColumns() uint32 {
	if x != nil {
		return x.Columns
	}
	return 0
...
func (x *ConnectStart) GetRows() uint32 {
	if x != nil {
		return x.Rows
	}
	return 0
...
type ConnectRequest struct {
	...
	//	*ConnectRequest_Resize
	//	*ConnectRequest_Interrupt
	//	*ConnectRequest_Keepalive
...
func (x *ConnectRequest) GetStart() *ConnectStart {
	if x != nil {
		if x, ok := x.Payload.(*ConnectRequest_Start); ok {
			return x.Start
		}
	}
	return nil
...
func (x *ConnectRequest) GetResize() *ResizeRequest {
	if x != nil {
		if x, ok := x.Payload.(*ConnectRequest_Resize); ok {
			return x.Resize
		}
	}
	return nil
...
func (x *ConnectRequest) GetInterrupt() *InterruptRequest {
	if x != nil {
		if x, ok := x.Payload.(*ConnectRequest_Interrupt); ok {
			return x.Interrupt
		}
	}
	return nil
...
func (x *ConnectRequest) GetKeepalive() *ConnectKeepalive {
	if x != nil {
		if x, ok := x.Payload.(*ConnectRequest_Keepalive); ok {
			return x.Keepalive
		}
	}
	return nil
...
type ConnectRequest_Start struct {
	Start *ConnectStart `protobuf:"bytes,1,opt,name=start,proto3,oneof"`
}
...
type ConnectRequest_Resize struct {
	Resize *ResizeRequest `protobuf:"bytes,3,opt,name=resize,proto3,oneof"`
}

type ConnectRequest_Interrupt struct {
	Interrupt *InterruptRequest `protobuf:"bytes,4,opt,name=interrupt,proto3,oneof"`
}

type ConnectRequest_Keepalive struct {
	Keepalive *ConnectKeepalive `protobuf:"bytes,5,opt,name=keepalive,proto3,oneof"`
}

func (*ConnectRequest_Start) isConnectRequest_Payload() {}

func (*ConnectRequest_Input) isConnectRequest_Payload() {}

func (*ConnectRequest_Resize) isConnectRequest_Payload() {}

func (*ConnectRequest_Interrupt) isConnectRequest_Payload() {}

func (*ConnectRequest_Keepalive) isConnectRequest_Payload() {}

type ConnectKeepalive struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ConnectKeepalive) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ConnectResponse) GetExitCode() int32 {
	if x != nil {
		return x.ExitCode
	}
	return 0
...
func (x *ConnectResponse) GetInputWait() bool {
	if x != nil {
		return x.InputWait
	}
	return false
...
func (x *ConnectResponse) GetTruncated() bool {
	if x != nil {
		return x.Truncated
	}
	return false
...
const file_proto_agentd_v1_agent_proto_rawDesc = "" +
	"\n" +
	"\x1bproto/agentd/v1/agent.proto\x12\tagentd.v1\"\x9f\x02\n" +
	...
	"\n" +
	"head_lines\x18\x06 \x01(\rR\theadLines\x12\x1d\n" +
	"\n" +
	"raw_output\x18\a \x01(\bR\trawOutput\x12\x18\n" +
	"\acolumns\x18\b \x01(\rR\acolumns\x12\x12\n" +
	"\x04rows\x18\t \x01(\rR\x04rows\"\xe5\x02\n" +
	...
	"\x04rows\x18\x03 \x01(\rR\x04rows\"\x92\x02\n" +
	"\x0eConnectRequest\x12/\n" +
	"\x05start\x18\x01 \x01(\v2\x17.agentd.v1.ConnectStartH\x00R\x05start\x12\x16\n" +
	"\x05input\x18\x02 \x01(\fH\x00R\x05input\x122\n" +
	"\x06resize\x18\x03 \x01(\v2\x18.agentd.v1.ResizeRequestH\x00R\x06resize\x12;\n" +
	"\tinterrupt\x18\x04 \x01(\v2\x1b.agentd.v1.InterruptRequestH\x00R\tinterrupt\x12;\n" +
	"\tkeepalive\x18\x05 \x01(\v2\x1b.agentd.v1.ConnectKeepaliveH\x00R\tkeepaliveB\t\n" +
	"\apayload\"\x12\n" +
	"\x10ConnectKeepalive\"\x9b\x01\n" +
	"\x0fConnectResponse\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status\x12\x16\n" +
	"\x06output\x18\x02 \x01(\fR\x06output\x12\x1b\n" +
	"\texit_code\x18\x03 \x01(\x05R\bexitCode\x12\x1d\n" +
	"\n" +
	"input_wait\x18\x04 \x01(\bR\tinputWait\x12\x1c\n" +
...
func file_proto_agentd_v1_agent_proto_init() {
	...
	file_proto_agentd_v1_agent_proto_msgTypes[9].OneofWrappers = []any{
		...
		(*ConnectRequest_Interrupt)(nil),
		(*ConnectRequest_Keepalive)(nil),
	}
	type x struct{}
